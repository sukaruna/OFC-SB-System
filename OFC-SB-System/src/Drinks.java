...
public class Drinks extends Product
{
	...
	public Drinks(String n, String t, int ls, int a, double p, double emp, int pu, int su, int y, int m, int d)
	{
		super(n, t, ls, a);
		setPrice(p);
	...
	public Drinks(String n, String t, int ls, int a, double p, int pu, int su)
	{
		this(n, t, ls, a, p, 0, pu, su, 0, 0, 0);
	}
